...
const fa: Partial<BillingCopy> = {
  ...
  featureVideoReelsDemo: "ریل ویدیوی AI ملک (با واترمارک دمو)",
  featureVideoReelsPro:
    "ریل‌های HD بدون واترمارک نامحدود با برندسازی آژانس",
  featureAiVision:
    "موتور بینایی AI (جنس، نور و جزئیات لوکس از روی عکس‌ها)",
  ...
  featureAudioDictationTrial: "۲ اعتبار دیکته صوتی",
  featureGeocodedLocation: "اطلاعات موقعیت مکانی ژئوکد شده",
  featureUnlimitedVoice: "دیکته صوتی و پردازش هوش مصنوعی نامحدود",
  featureAutomatedLocationPoi: "توضیحات خودکار موقعیت و نقاط مهم",
  freeTrialCardTitle: "نسخه آزمایشی رایگان",
  freeTrialPriceLabel: "۰ یورو",
  freeTrialFeaturePdfCredits: "۲ اعتبار رایگان exposé PDF",
  freeTrialCta: "ثبت‌نام رایگان",
  voiceUpgradeTitle: "برای دیکته نامحدود به Pro ارتقا دهید",
  voiceUpgradeBody:
    "۲ اعتبار صوتی رایگان شما تمام شد! برای دیکته نامحدود به Pro ارتقا دهید.",
...
const ar: Partial<BillingCopy> = {
  ...
  featureVideoReelsDemo: "ريل فيديو AI للعقار (يتضمن علامة demo)",
  featureVideoReelsPro:
    "ريل HD بلا علامة مائية غير محدود مع علامة الوكالة",
  featureAiVision:
    "محرك الرؤية AI (المواد والإضاءة والتشطيبات الفاخرة من الصور)",
  ...
  featureAudioDictationTrial: "رصيدان للإملاء الصوتي",
  featureGeocodedLocation: "رؤى الموقع الجغرافي المرمّز",
  featureUnlimitedVoice: "إملاء صوتي وتحليل ذكاء اصطناعي غير محدود",
  featureAutomatedLocationPoi: "أوصاف تلقائية للموقع ونقاط الاهتمام",
  freeTrialCardTitle: "تجربة مجانية",
  freeTrialPriceLabel: "0 €",
  freeTrialFeaturePdfCredits: "رصيدان مجانيان لـ exposé PDF",
  freeTrialCta: "سجّل مجاناً",
  voiceUpgradeTitle: "ترقية إلى Pro للإملاء غير المحدود",
  voiceUpgradeBody:
    "لقد استخدمت رصيدي الإملاء المجانيين! رقِّ إلى Pro للإملاء الصوتي غير المحدود.",
