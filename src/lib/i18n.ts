export const UI_LOCALES = ["en", "de", "fr", "es", "it", "nl", "pl"] as const;
...
export const translations: Record<UiLocale, UiCopy> = {
  en: {
    ...
    streetAddressPlaceholder: "Otto-Suhr-Allee",
    houseNumber: "House number",
    houseNumberPlaceholder: "27",
    unitNumber: "Unit / floor",
    unitNumberPlaceholder: "3rd Floor, Apt 12, Hinterhaus",
    postalCode: "ZIP code",
    postalCodePlaceholder: "14059",
    city: "City",
  ...
  de: {
    ...
    houseNumberPlaceholder: "27",
    unitNumber: "Wohnung / Etage",
    unitNumberPlaceholder: "3. OG links, Wohnung 12, Hinterhaus",
    postalCode: "PLZ",
    postalCodePlaceholder: "14059",
    city: "Stadt",
    cityPlaceholder: "Berlin",
  ...
  fr: {
    ...
    houseNumber: "Numéro",
    houseNumberPlaceholder: "27",
    unitNumber: "Appartement / étage",
    unitNumberPlaceholder: "3e étage, Apt 12",
...
export const RTL_UI_LOCALES: UiLocale[] = [];
