      ...
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        ...
        {onReset ? (
          <button
            ...
            title={copy.quickAutofillResetHint}
            className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-zinc-300 bg-white px-3 py-1.5 text-xs font-semibold text-zinc-700 transition hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-40 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800"
          >
            <RotateCcw className="h-3.5 w-3.5" aria-hidden />
            {copy.quickAutofillReset}
          </button>
        ) : null}
      </div>
